...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        ...
        bufp->chgIData(oldp+34,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__register[0]),32);
        bufp->chgIData(oldp+35,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__register[1]),32);
        bufp->chgIData(oldp+36,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__register[2]),32);
        bufp->chgIData(oldp+37,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__register[3]),32);
        bufp->chgIData(oldp+38,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__register[4]),32);
        bufp->chgIData(oldp+39,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__register[5]),32);
        bufp->chgIData(oldp+40,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__register[6]),32);
        bufp->chgIData(oldp+41,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__register[7]),32);
        bufp->chgIData(oldp+42,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__register[8]),32);
        bufp->chgIData(oldp+43,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__register[9]),32);
        bufp->chgIData(oldp+44,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__register[10]),32);
        bufp->chgIData(oldp+45,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__register[11]),32);
        bufp->chgIData(oldp+46,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__register[12]),32);
        bufp->chgIData(oldp+47,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__register[13]),32);
        bufp->chgIData(oldp+48,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__register[14]),32);
        bufp->chgIData(oldp+49,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__register[15]),32);
        bufp->chgIData(oldp+50,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__register[16]),32);
        bufp->chgIData(oldp+51,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__register[17]),32);
        bufp->chgIData(oldp+52,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__register[18]),32);
        bufp->chgIData(oldp+53,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__register[19]),32);
        bufp->chgIData(oldp+54,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__register[20]),32);
        bufp->chgIData(oldp+55,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__register[21]),32);
        bufp->chgIData(oldp+56,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__register[22]),32);
        bufp->chgIData(oldp+57,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__register[23]),32);
        bufp->chgIData(oldp+58,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__register[24]),32);
        bufp->chgIData(oldp+59,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__register[25]),32);
        bufp->chgIData(oldp+60,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__register[26]),32);
        bufp->chgIData(oldp+61,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__register[27]),32);
        bufp->chgIData(oldp+62,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__register[28]),32);
        bufp->chgIData(oldp+63,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__register[29]),32);
        bufp->chgIData(oldp+64,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__register[30]),32);
        bufp->chgIData(oldp+65,(vlSelf->top__DOT__singleCycle__DOT__regfile1__DOT__register[31]),32);
    }
